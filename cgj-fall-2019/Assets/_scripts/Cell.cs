...
public struct Cell
{
    ...
    {
        return new Cell(Mathf.FloorToInt(v2.x), Mathf.FloorToInt(v2.y));
    }

    public static explicit operator Cell(Vector3 v3)
    {
        return new Cell(Mathf.FloorToInt(v3.x), Mathf.FloorToInt(v3.y));
    }
